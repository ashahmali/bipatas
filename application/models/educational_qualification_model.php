<?php 
class educational_qualification_model extends ci_model {

	protected static $table_name = "academic_record";
    protected static $db_fields =array('personal_record_id', 'noprisch', 'pyoentry', 'pyograd', 'pqualobt', 'nosecsch', 'notersch', 'nysc');
